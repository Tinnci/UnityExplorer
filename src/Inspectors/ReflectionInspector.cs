...
namespace UnityExplorer.Inspectors
{
    ...
    public class ReflectionInspector : InspectorBase, ICellPoolDataSource<CacheMemberCell>, ICacheObjectController
    {
        ...
        void OnDnSpyButtonClicked()
        {
            ...
            {
                Notification.ShowMessage(Localizer.Get("MSG_SET_DNSPY_PATH", "Please set a valid dnSpy path in UnityExplorer Settings."));
            }
        }
        ...
        public override GameObject CreateContent(GameObject parent)
        {
            ...
            hiddenNameText = UIFactory.CreateInputField(titleHolder, "Title", Localizer.Get("LBL_NOT_SET", Localizer.Get("LBL_NOT_SET", "not set")));
            ...
            assemblyText = UIFactory.CreateLabel(asmRow, "AssemblyLabel", Localizer.Get("LBL_NOT_SET", Localizer.Get("LBL_NOT_SET", "not set")), TextAnchor.MiddleLeft);
        ...
        {
            string lblText = flags == BindingFlags.Default ? "All" : flags.ToString();
