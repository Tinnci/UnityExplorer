...
namespace UnityExplorer.UI.Widgets
{
    internal class TimeScaleWidget
    {
        ...
        void OnPauseButtonClicked()
        {
            ...
            lockBtn.ButtonText.text = locked ? Localizer.Get("BTN_UNLOCK", Localizer.Get("BTN_UNLOCK", "Unlock")) : Localizer.Get("BTN_LOCK", Localizer.Get("BTN_LOCK", "Lock"));
        }
        ...
        {
            Text timeLabel = UIFactory.CreateLabel(parent, "TimeLabel", Localizer.Get("LBL_TIME_SCALE", Localizer.Get("LBL_TIME_SCALE", "Time:")), TextAnchor.MiddleRight, Color.grey);
            ...
            lockBtn = UIFactory.CreateButton(parent, "PauseButton", Localizer.Get("BTN_LOCK", Localizer.Get("BTN_LOCK", "Lock")), new Color(0.2f, 0.2f, 0.2f));
