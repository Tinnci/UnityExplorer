    ...
    public class GameObjectInfoPanel
    {
        ...
        public void UpdateGameObjectInfo(bool firstUpdate, bool force)
        {
            ...
            if (force || Target.scene.handle != lastSceneHandle)
            {
                ...
                SceneButton.ButtonText.text = Target.scene.IsValid() ? Target.scene.name : Localizer.Get("LBL_NONE_ASSET_RESOURCE", Localizer.Get("LBL_NONE_ASSET_RESOURCE", "None (Asset/Resource)"));
            }
