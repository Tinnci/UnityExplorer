...
namespace UnityExplorer.UI.Panels
{
    public class ClipboardPanel : UEPanel
    {
        ...
        private static void InspectClipboard()
        {
            ...
            {
                Notification.ShowMessage(Localizer.Get("MSG_CANNOT_INSPECT_NULL", Localizer.Get("MSG_CANNOT_INSPECT_NULL", "Cannot inspect a null or destroyed object!")));
                return;
            }
        ...
        protected override void ConstructPanelContent()
        {
            ...
            CurrentPasteLabel = UIFactory.CreateLabel(currentPasteHolder, "CurrentPasteInfo", Localizer.Get("LBL_NOT_SET", Localizer.Get("LBL_NOT_SET", "not set")), TextAnchor.UpperLeft);
