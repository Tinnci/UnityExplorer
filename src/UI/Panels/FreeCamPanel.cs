...
namespace UnityExplorer.UI.Panels
{
    internal class FreeCamPanel : UEPanel
    {
        ...
        {
            startStopButton = UIFactory.CreateButton(ContentRoot, "ToggleButton", Localizer.Get("BTN_FREECAM", Localizer.Get("BTN_FREECAM", "Freecam")));
            ...
            GameObject posRow = AddInputField("Position", Localizer.Get("LBL_FREECAM_POS", Localizer.Get("LBL_FREECAM_POS", "Freecam Pos:")), Localizer.Get("TXT_FREECAM_POS_PLACEHOLDER", Localizer.Get("TXT_FREECAM_POS_PLACEHOLDER", "eg. 0 0 0")), out positionInput, PositionInput_OnEndEdit);
            ...
            AddInputField("MoveSpeed", Localizer.Get("LBL_MOVE_SPEED", Localizer.Get("LBL_MOVE_SPEED", "Move Speed:")), Localizer.Get("TXT_MOVE_SPEED_PLACEHOLDER", Localizer.Get("TXT_MOVE_SPEED_PLACEHOLDER", "Default: 1")), out moveSpeedInput, MoveSpeedInput_OnEndEdit);
...
- Shift: Super speed");
            ...
            inspectButton = UIFactory.CreateButton(ContentRoot, "InspectButton", Localizer.Get("BTN_INSPECT_FREECAM", Localizer.Get("BTN_INSPECT_FREECAM", "Inspect Free Camera")));
