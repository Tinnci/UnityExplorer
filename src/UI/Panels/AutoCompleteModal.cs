...
namespace UnityExplorer.UI.Panels
{
    ...
    public class AutoCompleteModal : UEPanel
    {
        ...
        protected override void ConstructPanelContent()
        {
            ...
            UIFactory.CreateLabel(navigationTipRow, "HelpText", Localizer.Get("LBL_AUTOCOMPLETE_HELP", Localizer.Get("LBL_AUTOCOMPLETE_HELP", "Up/Down to select, Enter to use, Esc to close")),
